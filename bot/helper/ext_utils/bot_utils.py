...
class MirrorStatus:
    STATUS_UPLOADING = "★彡[ᴜᴘʟᴏᴀᴅɪɴɢ]彡★...📤🇵🇰"
    STATUS_DOWNLOADING = "★彡[ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ]彡★...📥🇵🇰"
    STATUS_CLONING = "★彡[ᴄʟᴏɴɪɴɢ]彡★...♻️🇵🇰"
    STATUS_WAITING = "★彡[Qᴜᴇᴜᴇᴅ]彡★...💤🇵🇰"
    STATUS_PAUSED = "★彡[ᴘᴀᴜꜱᴇᴅ]彡★...⏸️🇵🇰"
    STATUS_ARCHIVING = "★彡[ᴀʀᴄʜɪᴠɪɴɢ]彡★...🔐🇵🇰"
    STATUS_EXTRACTING = "★彡[ᴇxᴛʀᴀᴄᴛɪɴɢ]彡★...📂🇵🇰"
    STATUS_SPLITTING = "★彡[ꜱᴘʟɪᴛᴛɪɴɢ]彡★...✂️🇵🇰"
    STATUS_CHECKING = "★彡[ᴄʜᴇᴄᴋɪɴɢᴜᴘ]彡★...📝🇵🇰"
    STATUS_SEEDING = "★彡[ꜱᴇᴇᴅɪɴɢ]彡★...🌧🇵🇰"
